...
### 安装方法
 ...
 ```
 git clone https://github.com/nulijiabei/ubuntu-xplay.git # (Master分支最新版本)
 或 
 git clone https://gitee.com/nljb/ubuntu-xplay.git # (Master分支最新版本)
 ```
 
 > 安装（注意：请您在(ROOT)用户下进行安装）  
 
 | 安装 | 框架 | 硬件 | 系统 | 备注 |  
 | --- | --- | --- | --- | --- |  
 | ubuntu/install.sh | X11 | AMD64 | ubuntu-20.04.3-desktop-amd64 | 仅桌面可运行(可窗口化) |  
